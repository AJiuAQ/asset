 ...
 */
@RestController
@RequestMapping("assetBorrows")
public class AssetBorrowApi {

    @Autowired
    AssetBorrowService assetBorrowService;

    @PostMapping("")
    public Result save(@Valid @RequestBody AssetBorrow assetBorrow) {
        assetBorrowService.save(assetBorrow);
        return Result.success(ResultCode.SUCCESS, assetBorrow);
    }
